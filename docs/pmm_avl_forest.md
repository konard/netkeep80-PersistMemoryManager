...
[TreeNode](../include/pmm/tree_node.h#pmm::TreeNode) в заголовке блока следует понимать как **универсальный intrusive AVL-slot**.
...
Это и есть смысл пары [Block](../include/pmm/block.h#pmm::Block) / [TreeNode](../include/pmm/tree_node.h#pmm::TreeNode):

- [Block](../include/pmm/block.h#pmm::Block) связывает forest с линейным ПАП;
- [TreeNode](../include/pmm/tree_node.h#pmm::TreeNode) делает этот блок узлом одного forest-домена.
...
- [Block](../include/pmm/block.h#pmm::Block) и [TreeNode](../include/pmm/tree_node.h#pmm::TreeNode) нужно объяснять через forest-модель, а не только через allocator.
