...
### 7.1. Free-tree как специализированная forest-policy (Issue #243)
...
- Исторический анализ идеи: [avl_forest_analysis_ru.md](avl_forest_analysis_ru.md)
- Расширенная концептуальная записка: [PMM_AVL_Forest_Concept.md](PMM_AVL_Forest_Concept.md)
