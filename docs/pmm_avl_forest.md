...
[TreeNode](../include/pmm/block_header.h#pmm-blockheader) в заголовке блока следует понимать как **универсальный intrusive AVL-slot**.
...
Это и есть смысл пары [Block](../include/pmm/block.h#pmm-block) / [TreeNode](../include/pmm/block_header.h#pmm-blockheader):

- [Block](../include/pmm/block.h#pmm-block) связывает forest с линейным ПАП;
- [TreeNode](../include/pmm/block_header.h#pmm-blockheader) делает этот блок узлом одного forest-домена.
...
- [Block](../include/pmm/block.h#pmm-block) и [TreeNode](../include/pmm/block_header.h#pmm-blockheader) нужно объяснять через forest-модель, а не только через allocator.
