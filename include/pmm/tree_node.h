...
namespace pmm {
enum : std::uint16_t {
kNodeReadWrite = 0, kNodeReadOnly = 1, };
/*
## pmm-treenode
*/
...
static_assert( std::is_standard_layout<pmm::TreeNode<pmm::DefaultAddressTraits>>::value, "TreeNode must be standard-layout ");
}
