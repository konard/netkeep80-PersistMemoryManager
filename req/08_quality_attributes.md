...
- **Приоритет:** Must
- **Статус:** Recovered
- **Основание:** `docs/validation_model.md`
...
- **Проверяется в:** [ac-003](12_acceptance_criteria.md#ac-003), `tests/test_avl_allocator.cpp`
...
- **Реализуется в:**
  ...
  - `include/pmm/address_traits.h`, `include/pmm/pptr.h`
